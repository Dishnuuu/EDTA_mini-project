...
def init_db() -> None:
    """Initialize database by creating tables and default admin users."""
    create_tables()
    ...
    try:
        ...
        default_admins = [
            ...
            {"username": "billing_admin", "password": "admin123", "department": "Billing & Accounts", "full_name": "Billing Department Admin"},
        ]
        ...
        db.commit()
        print("Database initialized successfully with default admin users!")
